  ...
  app_engine['pages'] = {
    ...
    add_store: function(_is_edit, _store) {
      ...
      */
      ...
      //the Brand ddl
      $('#ddl_f_countries').chosen({
        width: "100%",
        placeholder_text_multiple: ASL_REMOTE.LANG.select_countries || 'Select',
        no_results_text: ASL_REMOTE.LANG.no_countries || 'None'
      });

      $('#ddl_f_states').chosen({
        width: "100%",
        placeholder_text_multiple: ASL_REMOTE.LANG.select_states || 'Select',
        no_results_text: ASL_REMOTE.LANG.no_states || 'None'
      });
      ...
      $('#btn-asl-add').bind('click', function(e) {
        ...
        /*Attribute filter*/
        formData['data[countries]']   = $('#ddl_f_countries').val();
        formData['data[states]']      = $('#ddl_f_states').val();
