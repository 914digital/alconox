          ...
          <div class="card-body">
              <form id="frm-addstore">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 form-group mb-3">
                      <div class="form-group">
                        <label  for="ddl_f_countries"><?php echo __('Countries Filter','asl_admin') ?></label>
                        <select name="data[ddl_f_countries]"  id="ddl_f_countries" multiple class="asl-chosen chosen-select-width form-control">                      
                          <?php foreach($filter_countries as $f_country): ?>
                            <option  <?php foreach($store_countries as $s_value ) if($s_value == $f_country->id) echo 'selected="selected" '; ?> value="<?php echo $f_country->id ?>"><?php echo $f_country->name ?></option>
                          <?php endforeach ?>
                        </select>
                      </div>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                      <div class="form-group">
                        <label  for="ddl_f_states"><?php echo __('States Filter','asl_admin') ?></label>
                        <select name="data[ddl_f_states]"  id="ddl_f_states" multiple class="asl-chosen chosen-select-width form-control">                      
                          <?php foreach($filter_states as $f_state): ?>
                            <option  <?php foreach($store_states as $s_value ) if($s_value == $f_state->id) echo 'selected="selected" '; ?> value="<?php echo $f_state->id ?>"><?php echo $f_state->name ?></option>
                          <?php endforeach ?>
                        </select>
                      </div>
                    </div>
