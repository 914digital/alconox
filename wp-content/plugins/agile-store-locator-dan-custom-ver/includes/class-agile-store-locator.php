...
class AgileStoreLocator {
	...
	public function add_admin_menu() {
		...
		if (current_user_can('delete_posts')) {
			...
			add_submenu_page( 'asl-plugin', __('Manage Countries','asl_admin'), __('Manage Countries','asl_admin'), 'delete_posts', 'manage-asl-countries', array($this->plugin_admin,'admin_manage_countries'));
			add_submenu_page( 'asl-plugin', __('Manage States','asl_admin'), __('Manage States','asl_admin'), 'delete_posts', 'manage-asl-states', array($this->plugin_admin,'admin_manage_states'));
