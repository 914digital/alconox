...
class WC_AvaTax_Product_Admin {
	...
	public function display_quick_edit_fields() {
		...
		include( wc_avatax()->get_plugin_path() . '/src/admin/views/html-field-product-hts-code-quick-edit.php' );
	}
	...
	public function display_bulk_edit_fields() {
		...
		include( wc_avatax()->get_plugin_path() . '/src/admin/views/html-field-product-hts-code-bulk-edit.php' );
	}
