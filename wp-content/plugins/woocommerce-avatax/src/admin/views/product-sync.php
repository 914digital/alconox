...
<tr style="vertical-align: top;">
	...
	<td class="forminp forminp-product-sync" data-address-id="<?php echo esc_attr( $id ); ?>">
		...
		<p class="wc-avatax-product-sync validate">
			<span class="syncing" style="color: #89bf89; font-weight: bold; <?php echo $syncing ? '' : 'display: none;'; ?>"><?php esc_html_e( 'Your catalog is syncing to AvaTax.', 'woocommerce-avatax' ); ?></span>
			<span class="not-enabled" style="display: none;"><?php esc_html_e( 'Cross-border is not enabled on this account. Please contact your Customer Account Manager to setup Cross-Border tax calculation.', 'woocommerce-avatax' ); ?></span>
