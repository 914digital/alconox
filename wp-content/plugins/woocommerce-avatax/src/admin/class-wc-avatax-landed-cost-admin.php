...
class WC_AvaTax_Landed_Cost_Admin extends \WC_Settings_Page {
	...
	protected function output_list_screen() {
		...
		include( wc_avatax()->get_plugin_path() . '/src/admin/views/html-landed-cost-class-table.php' );
	...
	protected function output_code_edit_screen( $hts_code ) {
		...
		include( wc_avatax()->get_plugin_path() . '/src/admin/views/html-landed-cost-edit.php' );
	}
