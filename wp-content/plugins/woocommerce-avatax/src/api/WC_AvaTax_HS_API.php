...
class WC_AvaTax_HS_API extends WC_AvaTax_Abstract_API {
	...
	protected function get_new_request( $type = '', $args = null ) : Abstract_HS_Classification_Request {
		...
		switch ( $type ) {
			...
			case HS_Classification_Update_Request::class :
				$this->set_response_handler( HS_Classification_Update_Response::class );
				$request = new HS_Classification_Update_Request( $args );
				break;
	...
	/**
	 * Creates a new HS Classification.
	 *
	 * @since 1.13.0
	 *
	 * @param HS_Classification_Model $classification
