...
if(!empty($action) && !isset($_GET['action'])){
  ?>
   <div class="updated notice is-dismissible"><p><?php echo sprintf(__('Go to %sCRM Perks%s Page to manage Add-ons','woocommerce-salesforce-crm'),'<a href="'.$this->get_link('settings').'"><b>','</b></a>');?> </p>
  </div>  
  <?php
...
public function admin_menu(){ 
           $page_title =__('CRM Perks','woocommerce-salesforce-crm');
        $menu_title = __('CRM Perks','woocommerce-salesforce-crm');
...
add_menu_page($page_title, $menu_title, $capability, $this->id,$function,'data:image/svg+xml;base64,');
       $menu_title = __('Manage Add-ons','woocommerce-salesforce-crm');
...
/*      background: rgba(169, 0, 0, 0.06);*/
 ...
 <script type="text/javascript">
  jQuery(document).ready(function($){
     ...
     button.text('<?php _e('Wait...','woocommerce-salesforce-crm') ?>');
  ...
  <div class="wrap" data-class="<?php echo $this->id ?>"> 
     <h2><?php _e('Manage Add-ons','woocommerce-salesforce-crm'); ?></h2>
  <p><?php _e('You can activate, deactivate and delete add-ons here.','woocommerce-salesforce-crm'); ?> </p>
  <?php
...
$status=$this->plugin_status($plugin['class'],$slug);
 ...
 $refresh=admin_url( 'admin.php?page='.$this->id."&vx_action=get_addons");   
    ?>
<div style="text-align: center; padding-top: 50px;">  <form method="post"><button name="vx_action" class="button button-hero" value="get_addons"><?php _e('Refresh Add-ons List','woocommerce-salesforce-crm') ?></button></form>
...
public function addon_box($plugin,$status,$install_addon){
    $status_msg=array(__('Not Installed','woocommerce-salesforce-crm'),__('Active','woocommerce-salesforce-crm'),__('Disabled','woocommerce-salesforce-crm'));
  ...
  ?>
  <div class="vx_alert"><?php echo sprintf(__('This Plugin requires %s plugin','woocommerce-salesforce-crm'),"<i>".$addon['name']."</i>") ?></div>
  <?php
      }}
...
if($status == 1 && !empty($addon_version) && version_compare($addon_version,$plugin['version'],"<") ){
     $new_version=true;      
  ?>
  <div class="vx_alert"><?php echo sprintf(__('New Version %s is available.','woocommerce-salesforce-crm'),"<i>".$plugin['version']."</i>") ?></div>
  <?php
 }
  ?>
  <div class="vx_box_head"><?php echo $plugin['name'] ?></div>
  <div class="vx_box_info"><?php _e('Updated :','woocommerce-salesforce-crm'); ?> <i><?php echo $plugin['last_updated'] ?></i> &nbsp;&nbsp;&nbsp; <?php _e('Version :','woocommerce-salesforce-crm'); ?>  <i><?php echo $plugin['version'] ?></i></div>
 ...
 <div class="vx_box_footer">
  ...
  ?>
  <a href="<?php echo $install ?>" class="button button-primary"><?php _e('Install','woocommerce-salesforce-crm'); ?></a>
  <?php
      }else  if($status== 2 && $install_addon ){
      $activate=$this->get_link('activate',$plugin['plugin']);
      $delete=$this->get_link('delete',$plugin['plugin']);         
  ?>
    <a href="<?php echo $activate ?>" class="button button-primary vx_box_footer_link"><?php _e('Activate','woocommerce-salesforce-crm'); ?></a>
     <a href="<?php echo $delete ?>" class="button"><?php _e("Delete",'woocommerce-salesforce-crm'); ?></a> 
  <?php
      }else if($status== 1 ){ 
if($install_addon){
 $deactivate=$this->get_link('deactivate',$plugin['plugin']);  
  ?>
    <a href="<?php echo  $deactivate ?>" class="button button-primary vx_box_footer_link"><?php _e("Deactivate",'woocommerce-salesforce-crm'); ?></a>
  <?php
  }
  global ${$plugin['class']};
  $cl=${$plugin['class']};
if(!is_object($cl) && class_exists($plugin['class'])){
 ...
 $settings_link=admin_url('admin.php?page='.$cl->page);
  ?>
      <a href="<?php echo  $settings_link ?>" class="button button-secondary"><?php _e("Go to Settings",'woocommerce-salesforce-crm'); ?></a>   
     <?php
 }
      }
...
?>
<a href="<?php echo $install ?>" class="button button-primary"><?php _e('Upgrade','woocommerce-salesforce-crm'); ?></a>
    <?php 
   } 
  ?>
  </div>
...
public function manage_addons_action( $actions, $plugin_file ) {
        ...
        if(in_array($action,array('install-plugin','upgrade-plugin')) && $this->is_addon){
            $actions['plugins_page'] = '<a href="'.$this->get_link('settings').'">' . __('Back to CRM Perks Page', 'woocommerce-salesforce-crm') . '</a>';      
        }
...
public function manage_addons_ajax() {
    ...
    die(json_encode(array("status"=>"error","msg"=>__('Access Denied', 'woocommerce-salesforce-crm'))));
  }
check_ajax_referer("vx_nonce","vx_nonce"); 
  ...
  //   $error=__('You do not have sufficient permissions to manage plugins for this site.', 'woocommerce-salesforce-crm');
        
        if(empty($request)) {
        $error=__('Add-on name not specified.', 'woocommerce-salesforce-crm');
        }
  if(!empty($error)){
...
if(!$result){
    $error= __('ERROR', 'woocommerce-salesforce-crm');
}
                break;
        }
    ...
    ///  var_dump($plugins,$plugin); die();
      if(!isset($plugins[$p_arr[0]]['class'])){
          $error= __('Plugin Not Found', 'woocommerce-salesforce-crm'); 
      }
