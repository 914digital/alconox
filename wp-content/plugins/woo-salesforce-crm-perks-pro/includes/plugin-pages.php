...
if(!empty($v['placeholder'])){ $label=$v['placeholder']; }
  ...
  */
  ...
  ?>
  <div class="alert_danger"><?php _e('Please Select Object','woocommerce-salesforce-crm')?></div>
  <?php
  return;
  }
...
if($object_match && $account_match && $feed_match ){    
  ...
  */
  ...
  $html="<option value=''>".__("Select Object",'woocommerce-salesforce-crm')."</option>";
  $res=array();
...
$sql.=' order_id=%d order by id desc limit %d';
  ...
  */
  ...
  ?>
  <div class="alert_danger"><?php _e('Please Select a Salesforce Account','woocommerce-salesforce-crm')?></div>
  <?php
  die();
  }
