...
register_nav_menu('footer-main', __('Main Footer Menu'));
register_nav_menu('footer-ind', __('Footer Industries Menu'));
register_nav_menu('footer-prod', __('Footer Products Menu'));
register_nav_menu('ind-sidebar', __('Industry Sidebar'));
register_nav_menu('dl-sidebar', __('Downloads Sidebar'));
register_nav_menu('res-footer', __('Resources Footer'));
